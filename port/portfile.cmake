...
# Only support MSVC
if(NOT VCPKG_TARGET_IS_WINDOWS OR NOT VCPKG_TOOLCHAIN MATCHES "windows")
    message(FATAL_ERROR "This port only supports MSVC on Windows")
endif()
...
vcpkg_from_github(
    ...
    REPO sammiler/mlt
    REF msvc-master
    SHA512 0  # This will be updated when you test the port
